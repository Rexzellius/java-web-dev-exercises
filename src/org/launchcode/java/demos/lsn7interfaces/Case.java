...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Hot fudge", 0.75, new ArrayList<>(Arrays.asList("dairy", "soy")));
        Topping topping2 = new Topping("Peanuts", 0.50, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping3 = new Topping("Whipped Cream", 0.50, new ArrayList<>(Arrays.asList("dairy")));
