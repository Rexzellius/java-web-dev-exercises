...
public class QuizRunner {
    public static void main(String[] args) {
        ...
        CheckBoxQuestion newQuestion1 = new CheckBoxQuestion("Who is the best cat in the world?",2 , possAns1, correctAns1);
        ...
        TrueFalseQuestion newQuestion3 = new TrueFalseQuestion( "Are all dogs the best?", 1, true);
